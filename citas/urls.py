...
urlpatterns = [
    ...
    url(r'^cita/(?P<pk>\d+)/del/$', views.cita_del, name='cita_del'),
    ...
    url(r'^paciente/(?P<pk>\d+)/del/$', views.paciente_del, name='paciente_del'),
    ...
    url(r'^doctor/(?P<pk>\d+)/del/$', views.doctor_del, name='doctor_del'),
    ]
